...
public class MatematicaService {
    ...
    public MensajeResponse promedioCibertec(Integer cl1, Integer cl2, Integer cl3, Integer ap,Integer pf){
        Double promedioFinal = (cl1 * 0.15)+(cl2 * 0.25) + (cl3 * 0.3) +((ap + pf) / (2) * 0.35);
        return MensajeResponse.builder().resultado("Su promedio es:" + promedioFinal)
                .build();
    }
